...
(5.5,'values','이제 세 대상에 실제 값을 넣어봅시다.\n현재 값은 각각 10, 5, 20입니다.'),
(10.5,'destination','먼저 첫 번째 대상에 들어오는\n기여만 모아보겠습니다.'),
(14.5,'second','두 번째 대상의 값은 5.\n첫 번째에게 주는 영향은 0.8입니다.'),
(19.5,'multiply','따라서 이 연결이 만드는 기여는\n0.8 × 5 = 4입니다.'),
(24.5,'third','세 번째 대상에서도 값이 들어옵니다.\n0.1 × 20 = 2만큼 기여합니다.'),
(30.5,'arrive','출발점은 다르지만 목적지는 같습니다.\n같은 곳에 도착한 기여들을 더합니다.'),
(36,'sum','4 + 2 = 6.\n이것이 첫 번째 대상의 결과입니다.'),
(40,'zero','자기 자신에게서 오는 기여도 포함하면,\n0 × 10 + 4 + 2입니다.'),
(46,'symbolic','숫자 대신 기호로 적어도 같습니다.\n각 출발점의 값에 연결의 크기를 곱하고,\n그 기여들을 모두 더합니다.'),
(53,'roles','곱셈은 연결마다 기여를 만들고,\n덧셈은 같은 목적지의 기여를 모읍니다.'),
(58,'second_output','두 번째 대상도 똑같습니다.\n같은 입력값에서 오는 기여를 더하면 13입니다.'),
(63.5,'third_output','세 번째 대상은 5.5.\n목적지마다 기여를 모아 결과를 하나씩 얻습니다.'),
(69,'all_outputs','이 계산을 한 번에 적으면,\ny = Ax입니다.'),
(72.5,'interpret','행렬은 관계, 벡터는 현재 값.\n행렬과 벡터의 곱은 관계를 반영한 결과입니다.'),
(78,'row_meaning','행렬의 한 행은 한 목적지를 봅니다.\n그 행과 입력 벡터를 곱해 더하면,\n그 목적지의 결과 하나가 나옵니다.'),
