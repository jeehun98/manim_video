...
첫 번째는 한 선택지에 강하게 몰려 있고,
두 번째는 세 선택지의 확률이 거의 같습니다.

## 34초

이 차이를 숫자 하나로 표현하는 것이
엔트로피입니다.
...
이때 엔트로피는 0으로 가장 작습니다.

## 61초

반대로 세 확률이 모두 3분의 1이면,
...
이제 Temperature와 연결해보겠습니다.
점수 [1, 2, 3]은 고정하고 온도만 바꿉니다.

## 87초

Temperature를 낮추면 높은 점수에 확률이 몰리고,
엔트로피도 낮아집니다.

## 94초

반대로 Temperature를 높이면 분포가 평평해지고,
엔트로피는 높아집니다.

## 101초

Temperature는 분포의 모양을 바꾸고,
...
엔트로피가 나타내는 것은 정답 여부가 아니라,
현재 분포가 얼마나 집중되어 있는가입니다.

## 145초

소프트맥스가 점수들을 분포로 바꾼다면,
엔트로피는 그 분포의 집중도를
숫자 하나로 요약합니다.
